...
async function main() {
    ...
    const parentUser = await prisma.user.create({
        data: { email: 'parent1@mail.com', password: await bcryptjs_1.default.hash('Parent@123', 10), role: client_1.Role.PARENT, schoolId: school.id }
    });
    ...
    const teacherUser = await prisma.user.create({
        data: { email: 'teacher1@mail.com', password: await bcryptjs_1.default.hash('Teacher@123', 10), role: client_1.Role.TEACHER, schoolId: school.id }
    });
